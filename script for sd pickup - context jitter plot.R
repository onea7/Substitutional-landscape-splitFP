...
#Creating a gathered substitution table with standard deviations instead of average fluorescence

#Ran as a different script upon need, so it doesn't overcomplicate the main script for analysis
